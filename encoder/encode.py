import encoder.Mapper as Mapper

wordfile = open("encoder/words.nsv", 'r')  # Open Word List (newline separated value)
words = [w.replace('\n', '') for w in
         wordfile.readlines()]  # Load the words into an array while stripping the \n from each word
